...
export default function FileUpload({ onDataProcessed, onError }: FileUploadProps) {
  ...
  return (
    <div className="flex justify-between items-center py-2 px-4 w-full">
      <h1 className='sm:text-2xl'>Risoflora Finance</h1>
      <input
        type="file"
        accept=".csv"
        multiple
        ...
        className="block text-sm text-gray-500 file:mr-0 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
      />
      {isProcessing && (
