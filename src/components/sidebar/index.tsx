...
import { Home, LineChart, LogOut, Package, PanelBottom, Settings, ShoppingBag, Users } from "lucide-react";
                    ...
                    <Sheet>
                        ...
                        <SheetContent side="left" className="sm:max-w-xs">
                            ...
                            <nav className="grid gap-6 text-lg font-medium">
                                <Link href="#" className="ml-5 mt-5 flex h-10 w-10 bg-primary rounded-full text-lg items-center justify-center text-white md:text-base gap-2">
